<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SifreSifirla.aspx.cs" Inherits="WebSitem.SifreSifirla" %>
                    ...
                    <div class="col-md-8 col-10 my-5">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <h6 class="msg-info">Lütfen Yeni Şifrenizi Giriniz!!!</h6>
                                <div id="gizle2" class="form-group" >
                                    ...
                                    <div class="row justify-content-center my-3 px-3"> 
                                        <asp:Button ID="SifreGuncelle" CssClass="btn-block btn-color" runat="server" ForeColor="White" Text="Güncelle" OnClick="SifreGuncelle_Click"/>
                                        <asp:Label ID="GuncellemeSonuc" runat="server" ForeColor="Red" BackColor="Yellow" Text=""></asp:Label>
                                    </div>
