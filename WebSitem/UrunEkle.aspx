                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <asp:TextBox ID="urun_stok" CssClass="form-control" MaxLength="5" runat="server"></asp:TextBox>
                                ...
                                <div class="col-6 mb-4">
                                    ...
                                    <asp:TextBox ID="urun_fiyat" CssClass="form-control" MaxLength="5" runat="server"></asp:TextBox>
